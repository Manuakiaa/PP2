...
brush_icon = pygame.image.load(brush).convert_alpha()
rectangle_icon = pygame.image.load(rectangle).convert_alpha()
circle_icon = pygame.image.load(circle).convert_alpha()
eraser_icon = pygame.image.load(eraser).convert_alpha()
